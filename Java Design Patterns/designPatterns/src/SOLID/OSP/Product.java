...
class Demo {
    public static void main(String[] args) {
        ...
        Product tree = new Product("Tree", Color.GREEN, Size.LAGE);
        Product house = new Product("House", Color.BLUE, Size.LAGE);
        ...
        bf.filter(products,
                ...
                new SizeSpecification(Size.LAGE)))
